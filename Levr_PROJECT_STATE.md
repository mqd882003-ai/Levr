...
> Last updated: **2026-08-27** — Tier 1 segmentation fix (tool-forced structured output, `MAX_CHUNKS`
> 5→25 with truncation logging) + `business_evidence` guard, built and verified against the real API
> across multiple runs. Not yet pushed.
