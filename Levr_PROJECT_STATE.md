...
> Last updated: **2026-08-30** — Intent Router shipped end-to-end (Gate 1/2, all 5
> intents, universal processing state, orbit animation) AND the capture button
> copy change ("Sort it" → "Levr, go") both committed and live this session.
> Standing rule still applies: neither counted "done" until subtree-pushed +
