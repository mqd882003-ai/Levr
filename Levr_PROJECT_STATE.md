...
> Last updated: **2026-08-27** — Part 2 (post-capture clarifying questions on Home) built +
> live-tested, `mentioned_people` prompt tightened against lead/customer names. The earlier
> segmentation + `business_evidence` fixes were committed and pushed (`f82d39c` → GitHub `e8aaf29`)
> earlier today; the Part 2 round is committed on top, not yet pushed.
