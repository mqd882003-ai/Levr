...
> Last updated: **2026-08-26** — Tier 1 multi-chunk classification built, migrated, committed
> (`19f21c6`), pushed to GitHub. Retires Tier 2's splitting logic from the row below (superseded).
